...
from app.core.models_base import Base, JsonText, utcnow
...
class AppSetting(Base):
    ...
    value_json: Mapped[str] = mapped_column(JsonText, nullable=False)
    value_type: Mapped[str] = mapped_column(String(16), nullable=False)
    validation_schema_json: Mapped[str | None] = mapped_column(JsonText)
