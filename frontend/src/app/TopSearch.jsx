 ...
 *
 * 색은 전부 테마 토큰에서 온다. 예전에는 흰 글자 + 반투명 남색 바탕 리터럴이었는데,
 * 그건 **어두운 상단바를 전제한 값**이었다. D-141 로 chrome 이 캔버스 계열이 되면서 그
 * 값들이 그대로 남아 대비 1.21 로 떨어졌다(하네스가 잡았다). 상단바 위 요소는 상단바
 * 색을 전제하면 안 되고 토큰을 봐야 한다.
 */
  ...
  return (
    <Box
      ...
      sx={{
        ...
        height: "32px", pl: "34px", pr: "8px",
        border: "1px solid", borderColor: "divider", borderRadius: `${RADIUS.sm}px`,
    ...
    >
      ...
      <Box
        aria-hidden="true"
        sx={{ position: "absolute", left: "10px", top: "7px", display: "grid", color: "text.faint" }}
      >
      ...
      <Box
        ...
        sx={{
          ...
          color: "text.secondary", fontSize: FONT_SIZE.bodySm,
        }}
      >
        {placeholder}
      </Box>
      ...
      <Box
        ...
        sx={{
          ...
          border: "1px solid", borderColor: "divider", borderRadius: `${RADIUS.sm}px`,
          px: "5px", py: "1px", color: "text.faint",
