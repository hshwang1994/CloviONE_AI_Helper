...
export function Dashboard() {
  ...
  return (
    <Box className="c-screen">
      ...
      {/* 개인 업무(`WorkSection`)는 **여기 없다** (0060 §3).
          관리자 콘솔은 Control Plane 이다 — 운영·관리 정보만 둔다. "내 미완료·이번 주 마감·
          지연 티켓" 은 관리자에게도 개인 업무이고, 그 자리는 사용자 홈(`/me`)이다. 예전에는
          이 화면 하단 절반이 전부 사용자 콘솔로 나가는 링크였고, 누르는 순간 탭이 바뀌었다. */}
    </Box>
  );
}
