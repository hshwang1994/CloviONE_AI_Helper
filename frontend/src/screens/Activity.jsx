    ...
    >
      ...
      <Box sx={{ flex: 1, minWidth: 0 }}>
        <Box sx={{ display: "flex", gap: 1, alignItems: "center", flexWrap: "wrap" }}>
          <Typography sx={{ fontWeight: 650, minWidth: 0, wordBreak: "break-word" }}>
            {item.title}
          </Typography>
          ...
          {groups.map((g) => (
            <Box key={g.day} sx={{ mb: 2 }}>
              <Typography
                ...
                sx={{ display: "block", fontWeight: 750, py: 1, position: "sticky", top: 0, bgcolor: "background.paper", zIndex: 1 }}
              >
                {g.day}
              </Typography>
