 ...
 * APPROVAL_EXECUTORS)이 각각 users/integrations/schedules 중 하나를
...
describe("승인 화면 -> 대상 화면(users/integrations/schedules) 캐시", () => {
  ...
  it("승인 하나로 세 대상 화면 캐시가 전부 무효화된다(어느 유형인지 다시 안 가린다 — jobs->dashboard와 같은 판단)", async () => {
