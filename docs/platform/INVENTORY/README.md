...
**갱신**: 2026-08-21 (S1 — 01·02·04·05·06·08·10·12 의 S1 소유 항목이 닫혔다)
...
| 7 | [`07_NOTION.md`](07_NOTION.md) | Notion 워크스페이스 실측 + **토큰 위치** | 확보 (실 API 조회). S1 이 토큰 보관 위치와 secret-ref 계약을 더했다 |
...
| 12 | [`12_PROBE.md`](12_PROBE.md) | Checker / ui_qa 프로브와 알려진 거짓 통과 경로 8건 | **S1 이 8건 전부 수정** |
