...
"기존 백엔드에 UI만 없음" 부류(FN-01/03/04/05/06/09/10/11/14, SEC-04/05/10/11)는
넓은 조사에서 식별만 하고 손대지 않음(다음 사이클 후보).

**검증**: 신규 회귀 테스트 다수(러너 영향 없음, 백엔드 통합·보안 다수, 프런트 vitest 6)
전부 revert-to-verify. 프런트 vitest 201파일/1,335건, 러너 287건 전부 green. 백엔드
전체는 실행 중(§아래 갱신).
