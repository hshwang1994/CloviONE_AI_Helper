...
5. **G·K축 잔여.** `PA-RC-0015`로 G축을 처음 건드렸지만 **연동 실패 전파 자체**(n8n·Claude
   Runner 호출이 실패할 때 잡·대화·화면이 어떻게 되는가)와 **K축 전체**(대화 상태·intent·
   잡 수명주기·취소/재시도/타임아웃)는 미측정이다. 이 제품의 핵심 기능이라 우선순위가 높다.
